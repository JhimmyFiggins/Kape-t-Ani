     ...
     <!-- Add -->
      ...
      <?php
        ...
        if(isset($_POST["deleteCoffee"])){
          ...
          //Insert values to table
          mysqli_query($linkToDB, "DELETE FROM coffee_products WHERE id=$_POST[d_product_id]");
          ?>
          <script type="text/javascript">
          window.location.href=window.location.href;
          </script>
        ...
        if(isset($_POST["deleteCultural"])){
          ...
          //Insert values to table
          mysqli_query($linkToDB, "DELETE FROM cultural_products WHERE id=$_POST[d_product_id]");
          ?>
          <script type="text/javascript">
          window.location.href=window.location.href;
          </script>
        ...
        if(isset($_POST["deleteSeasonal"])){
          ...
          //Insert values to table
          mysqli_query($linkToDB, "DELETE FROM seasonal_products WHERE id=$_POST[d_product_id]");
          ?>
          <script type="text/javascript">
          window.location.href=window.location.href;
          </script>
